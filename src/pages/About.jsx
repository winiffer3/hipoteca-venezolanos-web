      ...
      <section id="about-valores">
        ...
        <div id="valores-grid">
          <div className="valor-card">
            ...
            <h3>+45 entidades bancarias</h3>
            <p>Trabajamos con más de 45 bancos para encontrar la mejor opción para tu perfil.</p>
          </div>
          <div className="valor-card">
            <span className="valor-icon">🤝</span>
            <h3>Trato personalizado</h3>
            <p>Cada cliente es único. Analizamos tu caso en detalle y buscamos la solución más adecuada.</p>
          </div>
          <div className="valor-card">
            <span className="valor-icon">🇻🇪</span>
            <h3>Entendemos tu situación</h3>
            <p>Conocemos los retos específicos de los venezolanos en España y sabemos cómo resolverlos.</p>
          </div>
          <div className="valor-card">
            <span className="valor-icon">⏱️</span>
            <h3>Ahorro de tiempo</h3>
            <p>Nosotros buscamos entre todos los bancos por ti. Tú solo firmas cuando todo esté listo.</p>
          </div>
        </div>
      </section>
